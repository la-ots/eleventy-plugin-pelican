...
module.exports = async function (eleventyConfig, options) {
  ...
  if (options.assets.core) {
    cssFiles = cssFiles.concat([
      path.join(options.basePath, 'node_modules/@la-ots/pelican/dist/css/pelican.min.css'),
      path.join(options.basePath, 'node_modules/@la-ots/eleventy-plugin-pelican/assets/css/docs.css'),
      path.join(options.basePath, 'node_modules/@la-ots/eleventy-plugin-pelican/assets/css/prism-theme.css')
    ])
    jsFiles = jsFiles.concat([
      path.join(options.basePath, 'node_modules/@la-ots/pelican/dist/js/pelican.bundle.min.js'),
      path.join(options.basePath, 'node_modules/@la-ots/eleventy-plugin-pelican/assets/js/docs.js')
    ])
  }
